                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
                            <tr>
                                <td class="content-wrapper" align="center" style="padding-left:24px;padding-right:24px;padding-top:24px;">
                                    ...
                                    <br><br>
                                    <div class="title" style="font-family: Helvetica, Arial, sans-serif;font-size: 33px;font-weight: lighter; color: #374550;">Hitecsa.com - Contacto</div>
                                    <br><br>
                                    <div><p style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;text-align:left;color:#333333;margin-top:12px">
                            <b>Nombre:</b> {{$data['name']}}<br/>
                            <b>Apellidos:</b> {{$data['surname']}}<br/>
                            <b>Email:</b> <a href="mailto:{{$data['from']}}">{{$data['from']}}</a><br/>
                            <b>Teléfono:</b> <a href="tel:{{$data['phone']}}">{{$data['phone']}}</a><br/>
                            <b>Provincia:</b><br/> {{$data['province']}}<br><br>
                            <b>Comentario:</b><br/> {{$data['message']}}<br><br>
                                        </p><br>
                                    </div>
                                </td>
                            </tr>
